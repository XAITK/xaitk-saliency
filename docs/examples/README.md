...
For issues relating to xaitk-saliency functionality or running of an example,
please create an issue on the
[repository](https://github.com/XAITK/xaitk-saliency/issues).
...
toolkit's current functionality. The CI workflow may be found in
`.github/workflows/ci-example-notebooks.yml`.

Not all are included in this CI due to their long-running or heavy resource
requirements. The specification of which notebooks are included in CI is around
L29 of the above referenced workflow configuration.
