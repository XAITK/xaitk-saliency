...
class SlidingWindow(PerturbImage):
    """Produce perturbation matrices from hard, block-y occlusion areas generated by sliding a window.

    A window of a configured size is slid over the area of an image.
