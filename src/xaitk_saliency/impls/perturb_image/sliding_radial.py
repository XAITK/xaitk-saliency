...
class SlidingRadial(PerturbImage):
    """Produce perturbation matrices generated by sliding a radial occlusion area with configured radius.

    This occurs over the area of an image. When the two radius values
