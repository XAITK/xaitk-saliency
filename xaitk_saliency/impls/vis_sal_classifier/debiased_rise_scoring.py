...
class DebiasedRISEScoring (ImageClassifierSaliencyMapGenerator):
    """
    ...
    def generate(
        ...
        # NOTE: Somehow we also need to get the `p` parameter from the generated masks,
        # but it is hard-coded here as 0.5 for now
        sal = weight_regions_by_scalar_rise(diff, perturbed_masks - 0.5)
