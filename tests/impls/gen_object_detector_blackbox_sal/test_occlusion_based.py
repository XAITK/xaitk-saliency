...
class TestPerturbationOcclusion:
    ...
    def test_generate_success(self) -> None:
        ...
        class StubGen(GenerateDetectorProposalSaliency):
            ...
            def generate(self, ref_dets: np.ndarray, pert_dets: np.ndarray, pert_masks: np.ndarray) -> np.ndarray:
        ...
        class StubDetector(DetectImageObjects):
            ...
            def detect_objects(
                ...
                for i, _ in enumerate(img_iter):
                    ...
                    yield [(AxisAlignedBoundingBox((0, 0), (1, 1)), {"class0": 0.0, "class1": 0.9}) for _ in range(i)]
        ...
        with mock.patch(
            ...
            test_result = inst._generate(test_image, test_bboxes, test_scores, test_detector)
